        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="item md-mb50">
              <div className="info sub-title p-color d-flex align-items-center mb-20">
                ...
                <div className="ml-30">
                  <a href="/blog-grid-sidebar">August 14, 2024</a>
                </div>
              </div>
              ...
              <div className="cont pt-30">
                <h5>The Future of AI in Web Development</h5>
                <a
                  href="/blog-details"
          ...
          <div className="col-lg-4">
            <div className="item md-mb50">
              ...
              <div className="cont pt-30">
                <h5>Mastering React for Scalable Applications</h5>
                <a
                  href="/blog-details"
                  className="butn-crev d-flex align-items-center mt-30"
                >
          ...
          <div className="col-lg-4">
            <div className="item">
              ...
              <div className="cont pt-30">
                <h5>Cybersecurity Best Practices for 2024</h5>
                <a
                  href="/blog-details"
                  className="butn-crev d-flex align-items-center mt-30"
                >
